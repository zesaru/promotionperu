    ...
    <Layout language={locale} articlePublishedTime="2025-05-28T00:00:00+09:00" title="INFOCOMEX - GDP Quarterly Report Q1 2025">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl bg-white japanese-text">
        ...
        <div className="text-center mb-6">
          <a
            href="https://mcusercontent.com/52e1146e92ef94295a8957364/files/d2ada55d-7072-9825-8d2b-80a3dd61ff2e/国内総生産_INFOCOMEX.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="mx-auto flex w-fit items-center gap-2 rounded bg-red-600 px-6 py-3 text-white no-underline transition-colors hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-800"
          >
            <ImDownload2 aria-hidden="true" />
