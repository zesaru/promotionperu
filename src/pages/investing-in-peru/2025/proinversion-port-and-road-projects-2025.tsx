      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">港湾プロジェクト</h3>

            <div className="space-y-6">
              <div>
                <h4 className="text-base font-semibold text-gray-900 mb-2">チンボテ港ターミナル</h4>
                <p className="text-sm text-blue-600 font-medium mb-2">3億5,400万米ドル</p>
              ...
              <div>
                <h4 className="text-base font-semibold text-gray-900 mb-2">SaramirizaおよびIquitos港ターミナル</h4>
                <p className="text-sm text-blue-600 font-medium mb-2">1億8,100万米ドル</p>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h4 className="text-base font-semibold text-gray-900 mb-2">プカルパ港ターミナル近代化</h4>
                <p className="text-sm text-blue-600 font-medium mb-2">3億1,500万米ドル</p>
                <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Port Community System（PCS）導入</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
          ...
          {/* New PPP Framework */}
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">新たな官民連携（PPP）制度</h3>
          ...
          {/* Road Projects */}
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">道路プロジェクト</h3>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">PROINVERSIONの成果</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <div className="mt-12 pt-6 border-t border-gray-300">
            <h3 className="text-base font-semibold text-gray-900 mb-2">参考文献</h3>
