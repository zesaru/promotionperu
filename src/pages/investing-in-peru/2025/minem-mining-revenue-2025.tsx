      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">資金移転の内訳</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-base font-semibold text-gray-900 mb-2">鉱業税（カノン）</h4>
                  <p className="text-sm text-blue-600 font-medium mb-2">6,992億ソル以上</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-base font-semibold text-gray-900 mb-2">鉱業ロイヤルティ</h4>
                  <p className="text-sm text-blue-600 font-medium mb-2">19億3,300万ソル以上</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-base font-semibold text-gray-900 mb-2">鉱業権更新料および罰金</h4>
                  <p className="text-sm text-blue-600 font-medium mb-2">2億5,600万ソル以上</p>
                  <p className="text-sm text-gray-700 leading-relaxed">
          ...
          {/* Purpose Statement */}
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">資金移転の目的</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">地域別資金移転額（上位4地域）</h3>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">MINEMの方針</h3>
            <p className="text-sm text-gray-700 leading-relaxed">
