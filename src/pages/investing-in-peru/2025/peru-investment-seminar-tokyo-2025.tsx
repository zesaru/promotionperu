    ...
    <Layout language={locale} title="ペルー投資機会セミナー2025開催">
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:max-w-4xl">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6 mb-6 md:mb-8">
            <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-4 japanese-text">主なスピーカー</h3>
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-base md:text-lg font-semibold text-gray-900 japanese-text">五十嵐 克也 氏</p>
                  <p className="text-xs md:text-sm text-gray-600 mb-1 japanese-text">日秘経済委員会（CEPEJA）事務総長</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-base md:text-lg font-semibold text-gray-900 japanese-text">芹生 太郎 氏</p>
                  <p className="text-xs md:text-sm text-gray-600 mb-1 japanese-text">米州開発銀行（IDB）アジア事務所長</p>
                  <p className="text-sm md:text-base text-gray-700 japanese-text">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-base md:text-lg font-semibold text-gray-900 japanese-text">舘 建一郎 氏</p>
                  <p className="text-xs md:text-sm text-gray-600 mb-1 japanese-text">国土交通省（MLIT）国際建設管理官</p>
                  <p className="text-sm md:text-base text-gray-700 japanese-text">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-base md:text-lg font-semibold text-gray-900 japanese-text">中畑 貴雄 氏</p>
                  <p className="text-xs md:text-sm text-gray-600 mb-1 japanese-text">日本貿易振興機構（JETRO）主幹</p>
                  <p className="text-sm md:text-base text-gray-700 japanese-text">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6 mb-6 md:mb-8">
            <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-4 japanese-text">主な参加企業</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm md:text-base text-gray-700 japanese-text">
              <div>
          ...
          <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-4 mt-8 japanese-text">
            セミナー成果
          </h3>

          <p className="mb-4 text-gray-700 leading-relaxed japanese-text">
