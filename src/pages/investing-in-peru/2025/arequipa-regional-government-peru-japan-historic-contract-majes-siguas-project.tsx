...
const InvestmentPage = () => {
  ...
  return (
    <Layout
      language={locale}
      articlePublishedTime="2025-10-10T00:00:00+09:00"
      title="ペルーと日本、Majes Siguas計画の改修・拡張に関する歴史的契約を締結"
      description="ペルーと日本は、Majes Siguas計画の改修・拡張に向けた歴史的契約を締結し、アレキパ州における重要インフラ整備の前進を確認しました。"
    >
      <Banner
        alt={"ペルーと日本によるMajes Siguas計画の歴史的契約に関するニュースバナー"}
        src={
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:max-w-4xl py-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          {/* Reference */}
          <div className="mt-8 md:mt-12 pt-4 md:pt-6 border-t border-gray-200">
            <h3 className="text-base md:text-lg font-semibold text-blue-800 mb-4 japanese-heading-3">参考文献</h3>
