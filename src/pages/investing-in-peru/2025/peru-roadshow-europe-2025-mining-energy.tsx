...
const InvestmentPage = () => {
  ...
  return (
    <Layout language={locale} articlePublishedTime="2025-09-10T00:00:00+09:00" title="ãƒšãƒ«ãƒ¼ã€é‰±æ¥­ãƒ»ç‚­åŒ–æ°´ç´ ãƒ»ã‚¨ãƒãƒ«ã‚®ãƒ¼åˆ†é‡Žã§æ¬§å·žå¤§æ‰‹æŠ•è³‡å®¶ã®é–¢å¿ƒã‚’ç²å¾— â€• ç¬¬18å›žãƒ­ãƒ¼ãƒ‰ã‚·ãƒ§ãƒ¼ãƒ»ãƒ¨ãƒ¼ãƒ­ãƒƒãƒ‘2025">
      <Banner
        alt={"ãƒšãƒ«ãƒ¼ã€é‰±æ¥­ãƒ»ç‚­åŒ–æ°´ç´ ãƒ»ã‚¨ãƒãƒ«ã‚®ãƒ¼åˆ†é‡Žã§æ¬§å·žå¤§æ‰‹æŠ•è³‡å®¶ã®é–¢å¿ƒã‚’ç²å¾— â€• ç¬¬18å›žãƒ­ãƒ¼ãƒ‰ã‚·ãƒ§ãƒ¼ãƒ»ãƒ¨ãƒ¼ãƒ­ãƒƒãƒ‘2025"}
        src={
