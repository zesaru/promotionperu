    ...
    >
      <article className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:py-12">
        ...
        <div className="space-y-6 text-gray-700 japanese-text">
          <p>
            9月8日（火）、ギジェルモ・シンノ・ワマニ・エネルギー鉱山大臣は、ケイコ・フジモリ大統領の新政権の下でペルー・エネルギー鉱山省（MINEM）が今後実施する改革と、ペルーの鉱業投資環境をより安定的で予見可能かつ投資しやすいものとするための具体的な措置を日本側に説明することを主な目的として、東京において日本政府関係者および鉱業・エネルギー分野の主要企業の幹部と会議を行った。
          </p>
